...
import { useCircuits, useCircuitsDispatch } from '../../providers/circuits';

export default function AddCircuit() {
  const dispatch = useCircuitsDispatch();
  ...
  const [typeCircuitId, setTypeCircuitId] = useState('');

  let nextId = useCircuits().length + 1;
  return (
    <div title='Create new circuit'>
      ...
      <div >
        ...
        <input
          ...
          value={typeCircuitId}
          onChange={e => setTypeCircuitId(e.target.value)}
        />
